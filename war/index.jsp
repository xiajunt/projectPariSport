  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <p class="lead">Game betting on NBA</p>
          <div class="list-group">
          	<!-- Lister la liste des conférences -->
          	<c:set var="isAlreadyShown" value="0"/>
          	<c:forEach var="standing" items="${listStandings}">
          		<c:choose>
				  <c:when test="${isAlreadyShown == '0'}">
				  	<a href="#" class="list-group-item active">${standing.divisionName}</a>
				  	<c:set var="isAlreadyShown" value="1" />
				  </c:when>
				  <c:otherwise>
				  	<a href="#" class="list-group-item">${standing.divisionName}</a>
				  </c:otherwise>
				</c:choose>
